...
export type Database = {
  public: {
    Tables: {
      profiles: {
        Row: Profile;
        Insert: Partial<Profile> & { id: string; nome: string; email: string; status_aprovacao: StatusAprovacao; role: UserRole };
